...
class DevGethProcess(BaseGethProcess):
    ...
    """
    def __init__(self, chain_name,_chainId,_maxpeers,_networkid,_bootnode, base_dir=None, overrides=None, genesis_data=None):
        ...
        if needs_init:
            ...
            initialize_chain(genesis_data,_chainId, **geth_kwargs)
