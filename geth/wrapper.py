...
def construct_test_chain_kwargs(**overrides):
    overrides.setdefault('max_peers', overrides['max_peers'])
    overrides.setdefault('network_id', overrides['network_id'])
    overrides.setdefault('boot_node', overrides['boot_node'])
...
def construct_popen_command(data_dir=None,
    ...
    if boot_node is not None:
        command.extend(('--bootnodes',boot_node))
